...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _modalProxy = __webpack_require__(89);
	
	var _modalProxy2 = _interopRequireDefault(_modalProxy);
	
	var _formlyProxy = __webpack_require__(91);
	
	var _formlyProxy2 = _interopRequireDefault(_formlyProxy);
	
	var _selectOptionManage = __webpack_require__(93);
...
/***/ (function(module, exports) {
	...
	var multiSelectTemplate = exports.multiSelectTemplate = {
	  template: "\n    <ol\n      class=\"nya-bs-select col-sm-12 col-xs-12 col-md-12 col-lg12\"\n      ng-model=\"model[options.key || index]\"\n      data-live-search=\"true\"\n      disabled=\"options.templateOptions.options.length === 0\">\n      <li nya-bs-option=\"option in  options.templateOptions.options group by option.group\">\n        <span class=\"dropdown-header\">\n          {{$group}}\n        </span>\n        <a>\n          <span>\n            {{option.name}}\n          </span>\n          <span class=\"glyphicon glyphicon-ok check-mark\"></span>\n        </a>\n      </li>\n    </ol>\n    "
	};
	
	var repeatSectionTemplate = exports.repeatSectionTemplate = {
...
/***/ (function(module, exports) {
	...
	function easyFormSteWayConfig($translateProvider) {
	  ...
	  function controlsList() {
	    var controls = [{ name: 'empty', enabled: true }, { name: 'Header', enabled: true }, { name: 'Subtitle', enabled: true }, { name: 'TextInput', enabled: true },
	    // {name: 'Password',       enabled: true},
	    { name: 'Email', enabled: true },
	    // {name: 'IpAdress',       enabled: true},
	    { name: 'Date', enabled: true }, { name: 'Texarea', enabled: true }, { name: 'DateTime', enabled: true }, { name: 'RepeatSection', enabled: true }, { name: 'RichTextEditor', enabled: true }, { name: 'Radio', enabled: true }, { name: 'Checkbox', enabled: true }, { name: 'BasicSelect', enabled: true }, { name: 'NumberInput', enabled: true }, { name: 'MultiSelect', enabled: true }, { name: 'GroupedSelect', enabled: true }];
	    return controls;
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _numberInput = __webpack_require__(59);
	
	var _editNumberInput = __webpack_require__(60);
	
	var _editNumberInput2 = _interopRequireDefault(_editNumberInput);
	
	var _multiSelect = __webpack_require__(61);
	
	var _editMultiSelect = __webpack_require__(62);
	
	var _editMultiSelect2 = _interopRequireDefault(_editMultiSelect);
	
	var _datetime = __webpack_require__(63);
	
	var _editDateTime = __webpack_require__(64);
	
	var _editDateTime2 = _interopRequireDefault(_editDateTime);
	
	var _repeatGroup = __webpack_require__(65);
	
	var _editRepeatGroup = __webpack_require__(66);
	
	var _editRepeatGroup2 = _interopRequireDefault(_editRepeatGroup);
	...
	var configs = [
	// IpAdressConfig,
	_date.DateConfig, _numberInput.NumberInputConfig, _multiSelect.MultiSelectConfig, _datetime.DateTimeConfig, _checkbox.CheckBoxConfig, _email.EmailConfig, _basicSelect.BasicSelectConfig, _blank.BlankConfig, _groupedSelect.GroupedSelectConfig, _header.HeaderConfig,
	// PasswordConfig,
	_radio.RadioConfig, _richTextEditor.RichTextEditorConfig, _subTitle.SubTitleConfig, _textArea.TextAreaConfig, _textInput.TextInputConfig, _repeatGroup.RepeatSectionConfig];
	  ...
	  formlyValidation: {
	    messages: {
	      required: function required(viewValue, modelValue, scope) {
	        var defaultReturnMsg = 'this NumberInput field is required';
...
/***/ (function(module, exports) {
	...
	var EDIT_NUMBERINPUT_COMPONENT = exports.EDIT_NUMBERINPUT_COMPONENT = 'editNumberInputControl';
	
	var editNumberInputControlComponent = exports.editNumberInputControlComponent = {
	  ...
	  controller: (_temp = _class = function editNumberInputControlController() {
	    _classCallCheck(this, editNumberInputControlController);
	  }, _class.$inject = [], _temp)
	};
	
	var editNumberInputModuleName = 'stepway.editNumberInput.module';
	
	exports.default = angular.module(editNumberInputModuleName, []).component(EDIT_NUMBERINPUT_COMPONENT, editNumberInputControlComponent);
...
/***/ (function(module, exports) {
	...
	var EDIT_MULTI_SELECT_COMPONENT = exports.EDIT_MULTI_SELECT_COMPONENT = 'editMultiSelectControl';
	
	var editMultiSelectControlComponent = exports.editMultiSelectControlComponent = {
	  ...
	  controller: (_temp = _class = function editMultiSelectControlController() {
	    _classCallCheck(this, editMultiSelectControlController);
	  }, _class.$inject = [], _temp)
	};
	
	var editMultiSelectModuleName = 'stepway.editMultiSelect.module';
	
	exports.default = angular.module(editMultiSelectModuleName, []).component(EDIT_MULTI_SELECT_COMPONENT, editMultiSelectControlComponent);
	...
	// <optgroup label="{{multiSelectRow.group}}" ng-repeat="multiSelectRow in $ctrl.multiSelectRowCollection.rows | orderBy : '-group'">
	//   <option  
	//     value="$index">
	//           {{multiSelectRow.option}}
	//   </option>
	...
	// <optgroup label="{{key.group}}" ng-repeat="(key, value) in $ctrl.multiSelectRowCollection.rows | groupBy : 'group'">
	//   <option  ng-repeat="item in value"
	//     value="$index">
	//           {{item.option}}
	//   </option>
	// </optgroup>
	...
	// <optgroup label="{{filtergroup.group}}" ng-repeat="filtergroup in $ctrl.nyaSelect.temporyConfig.multifilter | orderBy:'group' ">
	//   <option  ng-repeat="multiSelectRow in $ctrl.multiSelectRowCollection.rows | filter: { group : filtergroup.group }  "
	//     value="$index">
	//           {{multiSelectRow.option}}
	//   </option>
	// </optgroup>
...
/***/ (function(module, exports) {
	...
	var DateTimeConfig = exports.DateTimeConfig = {
	  id: 'DateTime',
	  name: 'DateTime',
	  subtitle: 'DateTime',
	  group: 'input',
	  ...
	  formlyValidation: {
	    messages: {
	      required: function required(viewValue, modelValue, scope) {
	        ...
	        //-> '<label as name> is required '
	        //-> or if not exists or empty just 'this field is required'
	        var defaultReturnMsg = 'this DateTime field is required';
	        var returnMsg = typeof scope.to.label !== 'undefined' ? scope.to.label !== '' ? scope.to.label + ' is required' : defaultReturnMsg : defaultReturnMsg;
	        return returnMsg;
	      }
	    }
...
/***/ (function(module, exports) {
	...
	var EDIT_DATE_TIME_COMPONENT = exports.EDIT_DATE_TIME_COMPONENT = 'editDateTimeControl';
	
	var editDateTimeControlComponent = exports.editDateTimeControlComponent = {
	  ...
	  controller: (_temp = _class = function editDateTimeControlController() {
	    _classCallCheck(this, editDateTimeControlController);
	  }, _class.$inject = [], _temp)
	};
	
	var editDateTimeControlModuleName = 'stepway.editDateTimeControl.module';
	
	exports.default = angular.module(editDateTimeControlModuleName, []).component(EDIT_DATE_TIME_COMPONENT, editDateTimeControlComponent);
...
/***/ (function(module, exports) {
	...
	var RepeatSectionConfig = exports.RepeatSectionConfig = {
	  id: 'RepeatSection',
	  name: 'RepeatSection',
	  ...
	  formlyValidation: {
	    messages: {
	      required: function required(viewValue, modelValue, scope) {
	        var defaultReturnMsg = 'this RepeatSection field is required';
	        var returnMsg = typeof scope.to.label !== 'undefined' ? scope.to.label !== '' ? scope.to.label + ' is required' : defaultReturnMsg : defaultReturnMsg;
	        return returnMsg;
	      }
	    }
...
/***/ (function(module, exports) {
	...
	var EDIT_REPEAT_SECTION_CONTROL_COMPONENT = exports.EDIT_REPEAT_SECTION_CONTROL_COMPONENT = 'editRepeatSectionControl';
	
	var editRepeatSectionControlComponent = exports.editRepeatSectionControlComponent = {
	  template: '\n    <div class="panel panel-default"  ng-controller="demoController as vm">\n    <div class="panel-body">\n      <div class="row">\n        <div class="col-md-12">\n          <h5 class="greyText">\n            <i class="fa fa-eye"></i>\n            &nbsp;\n            {{\'PREVIEW_TAB\' | translate}} :\n          </h5>\n        </div>\n      </div>\n      <hr/>\n      <div class="row">\n        <div class="col-md-12">\n          <div class="form-group">\n            <label\n              for="repeatSection"\n              class="control-label textControlLabel">\n              {{$ctrl.nyaSelect.temporyConfig.formlyLabel}}\n              <span\n                ng-if="$ctrl.nyaSelect.temporyConfig.formlyRequired"\n                class="textControlLabel">\n                *\n              </span>\n            </label>\n            <div class="">\n            \n                <form ng-submit="vm.onSubmit()" novalidate>\n                  <formly-form model="vm.model" fields="vm.fields" form="vm.form" options="vm.options">\n                    <button type="submit" class="btn btn-primary submit-button" ng-disabled="vm.form.$invalid">Submit</button>\n                  </formly-form>\n                </form>\n                <hr />\n                <h2>Model</h2>\n                <pre>{{vm.model | json}}</pre>\n                <h2>Fields <small>(note, functions are not shown)</small></h2>\n                <pre>{{vm.originalFields | json}}</pre>\n                <h2>Form</h2>\n                <pre>{{vm.form | json}}</pre>\n\n                <p class="help-block">\n                  {{$ctrl.nyaSelect.temporyConfig.formlyDescription}}\n                </p>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <script type="text/ng-template" id="repeatSection.html">\n      <div>\n      \t<!--loop through each element in model array-->\n      \t<div class="{{hideRepeat}}">\n          <div class="repeatsection" ng-repeat="element in model[options.key]" ng-init="fields = copyFields(to.fields)">\n            <formly-form fields="fields"\n                         model="element"\n                         form="form">\n            </formly-form>\n            <div style="margin-bottom:20px;">\n              <button type="button" class="btn btn-sm btn-danger" ng-click="model[options.key].splice($index, 1)">\n                Remove\n              </button>\n            </div>\n            <hr>\n        </div>\n        <p class="AddNewButton">\n  \t      <button type="button" class="btn btn-primary" ng-click="addNew()" >{{to.btnText}}</button>\n        </p>\n      </div>\n    </script>\n  </div>\n  ',
	  bindings: {
	    nyaSelect: '='
	  },
	  controller: (_temp = _class = function editRepeatSectionControlController() {
	    //
	
	    _classCallCheck(this, editRepeatSectionControlController);
	  }, _class.$inject = [], _temp)
	};
	
	var editRepeatSectionModuleName = 'stepway.editRepeatSectionControl.module';
	
	exports.default = angular.module(editRepeatSectionModuleName, []).component(EDIT_REPEAT_SECTION_CONTROL_COMPONENT, editRepeatSectionControlComponent);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _modalProxyServiceHelpers = __webpack_require__(90);
	    ...
	    value: function getNyASelectFromSelectedLineColumn(nyaSelectObj, configurationObj, indexLine, numcolumn) {
	      ...
	      if (controlAtThisLineThisCol && controlAtThisLineThisCol.templateOptions) {
	        ...
	        if (nyaSelectObj.temporyConfig.selectedControl === 'DateTime') {
	          nyaSelectObj.temporyConfig.datetimepickerOptions = controlAtThisLineThisCol.templateOptions.datetimepickerOptions ? angular.copy(controlAtThisLineThisCol.templateOptions.datetimepickerOptions) : { format: '' };
	        }
	      }
	      return nyaSelectObj;
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _formlyProxyService = __webpack_require__(92);
...
/***/ (function(module, exports) {
	...
	var extractTemplateOptionDateTimepickerOptions = function extractTemplateOptionDateTimepickerOptions(obj) {
	  var defaultValue = { format: '' };
	  if (isTemplateOptionDefined(obj) && obj.templateOptions.datetimepickerOptions) {
	    return _extends({}, obj.templateOptions.datetimepickerOptions);
	  }
	  return defaultValue;
	};
	...
	var addDateTimepickerOptionsProperty = function addDateTimepickerOptionsProperty(fieldToPush, configurationModel, lineIndex) {
	  var control = _extends({}, configurationModel.lines[lineIndex].columns[0].control);
	...
	exports.extractTemplateOptionDateTimepickerOptions = extractTemplateOptionDateTimepickerOptions;
	...
	exports.addDateTimepickerOptionsProperty = addDateTimepickerOptionsProperty;
...
/***/ (function(module, exports) {
	...
	var selectOptionManage = function () {
	  ...
	  _createClass(selectOptionManage, [{
	    ...
	    key: 'addNewOptionMultiSelect',
	    value: function addNewOptionMultiSelect(selectObj, newOptionText, newOptionGroup) {
	      var fullResponse = {
	        resultFlag: false,
	        details: ''
	      };
